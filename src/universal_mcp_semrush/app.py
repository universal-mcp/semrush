...
class SemrushApp(APIApplication):
    ...
    def domain_organic_search_keywords(
        ...
        """
        Get domain organic search keywords data from Semrush API.
        
        This report lists keywords that bring users to a domain via Google's top 100 
        organic search results. You can get monthly rankings from as far back as 
        2012–2016, depending on the database, or daily rankings for the last 31 days.
