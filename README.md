...
You can start using Semrush directly from [agentr.dev](https://agentr.dev). Visit [agentr.dev/apps](https://agentr.dev/apps) and enable Semrush.
...
The full list of available tools is at [Tools](./src/universal_mcp_semrush/README.md)
